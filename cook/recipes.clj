[
  ...
  }
  {
    ...
    :ingredients [
      ["225 plain flour"
      "175g plant butter, chilled, in small pieces"]
    ...
    :method [
      ...
      "Sift the flour into a bowl, add the salt. Add the butter. The butter could be cut by hand,
      use the flour to keep it from sticking, or a food processor can be used. The pieces should be smaller than 1cm.
      If they are too big, it will leak and prevent layers from forming. Add the water, and bring together without kneading."

      "Roll out the dough into a rectangle about 8cm wide and 24cm in length. Fold the top third down, then the bottom third
      on top of that. Turn clock-wise 90 degrees. Wrap in baking paper and chill. Repeat 3 times."

      "200C for about 30 minutes."

      "Alternative amounts are 180g flour, 140gr butter, 80ml water"
    ]
  }
  {
...

  {
    ...
    :method [
      "Cream the butter and the sugars. Add the vanilla, flour and salt. Add the chips, preferably dark chocolate."
      "Create balls of about 50gr. Squash them slightly if you like a flatter cookie."
      "Bake at 180C for about 10 minutes. Take out of the oven, let set for a minute before transferring to cooling rack."
    ]
  }
